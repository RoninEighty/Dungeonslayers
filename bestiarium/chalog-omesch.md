...
|                    Bewaffnung                     |
| :-----------------------------------------------: |
| Armbrust, leicht (2h) (WB+4, GA-2, [Verletzen](talente/verletzen.md) +II) |

|                      Panzerung                      |
| :-------------------------------------------------: |
| Lederpanzer (PA+3, Zauber: [Balancieren](zauber/balancieren.md) eingebettet) |

**Ausrüstung:** Kompass (Zauber: [Magie entdecken](zauber/magie-entdecken.md) eingebettet, Zauber: [Verborgenes sehen](zauber/verborgenes-sehen.md) eingebettet)
